...
def main():
    ...
    csv_file1 = r'C:\Users\IT\Downloads\recon_updated (1)\Recon (2)\Recon\Output_Files\iCloud_Payment.csv'
...
# def main():
#     """Main function to load iCloud Payment CSV and insert into MySQL"""
#     # Auto-detect CSV path
#     script_dir = Path(__file__).parent
#     csv_file_path = script_dir / 'Output_Files' / 'iCloud_Payment.csv'
    
#     print(f"Looking for iCloud Payment CSV file at: {csv_file_path}")
    
#     if not csv_file_path.exists():
#         print(f"❌ iCloud Payment CSV file not found at {csv_file_path}")
#         return
...
#             connection.commit()
#             print("✅ iCloud Payment data loaded successfully")
