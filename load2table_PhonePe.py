...
def main():
    ...
    csv_file2 = r'C:\Users\IT\Downloads\recon_updated (1)\Recon (2)\Recon\Output_Files\output_PhonePe.csv'
...
# def main():
#     """Main function to load PhonePe CSV and insert into MySQL"""
#     # Auto-detect CSV path
#     script_dir = Path(__file__).parent
#     csv_file_path = script_dir / 'Output_Files' / 'output_PhonePe.csv'
    
#     print(f"Looking for PhonePe CSV file at: {csv_file_path}")
    
#     if not csv_file_path.exists():
#         print(f"❌ PhonePe CSV file not found at {csv_file_path}")
#         return
...
#             connection.commit()
#             print("✅ PhonePe data loaded successfully")
